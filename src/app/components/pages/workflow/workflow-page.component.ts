...
import { TICKET_STATUS_CODES, TICKET_STATUS_LABELS } from 'src/app/constants/ticketStatus';
...
export class WorkflowPageComponent implements OnInit {
  ...
  updateCardStatus(ticket: Ticket, newStatus: string) {
    ...
    this.ticketService.updateTicket(ticket._id, ticket).subscribe((updatedTickets: Ticket[]) => {
